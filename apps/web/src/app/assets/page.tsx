            ...
            <AppShell>
                <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <div style={{ width: "40%", height: "28px" }} className="skeleton" />
                        <div style={{ width: "20%", height: "35px" }} className="skeleton" />
                    </div>
            ...
            <AppShell>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "var(--space-14)", textAlign: "center" }}>
                    ...
                    <p style={{ fontSize: 14, color: "var(--text-secondary)", margin: "0 0 var(--space-6) 0", maxWidth: 360 }}>
                        Connect an Instagram Business profile connection first to browse assets.
                    </p>
                    <button
                        onClick={() => router.push("/")}
                        style={{
    ...
    return (
        <AppShell>
            <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-6)" }}>
                ...
                >
                    <div>
                        ...
                        <p style={{ fontSize: "13px", color: "var(--text-secondary)", margin: "4px 0 0 0" }}>
                            Manage, sync, and inspect Instagram Reels, carousel posts, comments, and metrics.
                        </p>
                    </div>
                ...
                >
                    <HelpCircle size={15} color="var(--primary)" style={{ flexShrink: 0 }} />
                    <p style={{ fontSize: 12, color: "var(--text-secondary)", margin: 0 }}>
                        Double-click any media cards to see detailed information, estimated reach, and direct links inside the Creator Studio detail panel.
                    </p>
                </div>
