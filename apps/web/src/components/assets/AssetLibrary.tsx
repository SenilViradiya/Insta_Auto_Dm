  ...
  const renderSkeletons = () => (
    <div
      style={{
        display: "grid",
        gridTemplateColumns:
          viewMode === "GRID" ? "repeat(auto-fill, minmax(160px, 1fr))" : "1fr",
        gap: "var(--space-3)",
      }}
    >
      {[1, 2, 3, 4].map((n) => (
        ...
        >
          <div
            style={{
              width: viewMode === "GRID" ? "100%" : "50px",
              height: viewMode === "GRID" ? "100px" : "100%",
          ...
          >
            <div
              style={{ width: "80%", height: "12px", borderRadius: 4 }}
              className="skeleton"
            />
            <div
              style={{ width: "50%", height: "10px", borderRadius: 4 }}
              className="skeleton"
            />
          </div>
        </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "4px",
              background:
                viewMode === "LIST" ? "var(--surface)" : "transparent",
              color:
        ...
        >
          <RefreshCw
            size={11}
            className={syncMutation.isPending ? "spin-animation" : ""}
          />
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          {isLoading ? (
            ...
            >
              Unable to load media assets from local cache server. Try
              synchronising.
            </div>
            ...
            >
              ...
              >
                Make sure your Instagram account has published Reels/Posts, or
                clear filters.
              </span>
              <button
                onClick={handleSyncClick}
            ...
            <div>
              ...
              >
                ...
                <span style={{ fontWeight: 600, color: "var(--text-primary)" }}>
                  {previewAsset.timestamp
                    ? new Date(previewAsset.timestamp).toLocaleDateString()
                    : ""}
                </span>
              </div>
            </div>
