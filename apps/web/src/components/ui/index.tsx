      ...
      {(title || extra) && (
        <div
          style={{
            ...
            borderBottom: description ? "none" : "1px solid var(--divider)",
            paddingBottom: description ? 0 : "12px",
          }}
        >
          <div>
            {title && (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <strong style={{ fontSize: 12, color: "var(--success)" }}>
            {successRate}
          </strong>
        </div>
        <div style={{ display: "flex", flexDirection: "column" }}>
  ...
  return (
    <span
      style={{
        ...
        color: badge.text,
        border:
          badge.border !== "transparent" ? `1px solid ${badge.border}` : "none",
        fontSize: "11px",
        fontWeight: 600,
        width: "fit-content",
      }}
...
export function EmptyState({
  ...
  return (
    ...
    >
      ...
      <span
        style={{ fontSize: 13, fontWeight: 650, color: "var(--text-primary)" }}
      >
        {title}
      </span>
      <span
