...
export const TRIGGER_REGISTRY: Record<TriggerType, TriggerMetadata> = {
  DIRECT_MESSAGE: {
    ...
    explanation:
      "Listens to direct messages sent to your inbox. You can match all incoming messages or filter by specific keywords.",
  ...
  REEL_COMMENT: {
    ...
    explanation:
      "Listens for comment interactions on all Reels or a specific linked Reel. Supports automatic comment reply and keyword filtering.",
  ...
  POST_COMMENT: {
    ...
    explanation:
      "Listens for comment interactions on your standard feed posts. Works on all media items or specific posts.",
  ...
  STORY_REPLY: {
    ...
    explanation:
      "Listens to private chat replies generated when visitors react to any of your active published Page Stories.",
  ...
  STORY_MENTION: {
    ...
    explanation:
      "Triggers your marketing and response pipeline as soon as another Instagram user tags or mentions your handle in their story.",
