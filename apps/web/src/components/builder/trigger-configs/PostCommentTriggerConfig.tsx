        ...
        <Radio.Group
          ...
          onChange={(e: any) =>
            handleUpdate({
              ...
              mediaId: e.target.value === "ALL_POSTS" ? "" : mediaId,
            })
          }
          size="middle"
        >
      ...
      {mediaScope === "SPECIFIC_POST" && (
        ...
        >
          ...
          {mediaScope === "SPECIFIC_POST" && !mediaId && (
            ...
            >
              * Select a specific feed post from the library to apply automation
              rules.
            </span>
          )}
        </div>
      ...
      {matchType === "KEYWORD" && (
        ...
        >
          <span style={{ fontSize: 12, color: "var(--text-secondary)" }}>
            Trigger only when incoming comments contain any of the following
            keyword tags:
          </span>
          <div
